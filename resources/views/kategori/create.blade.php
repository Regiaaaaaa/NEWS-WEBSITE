    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Kategori</h1>
                    <p class="text-gray-600">Buat kategori baru untuk mengorganisir data Anda</p>
                </div>
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-sm font-medium text-blue-800 mb-1">Tips Membuat Kategori</h3>
                    <p class="text-sm text-blue-700">
                        Gunakan nama yang singkat dan deskriptif. Kategori yang baik memudahkan pencarian dan organisasi data di masa depan.
                    </p>
                </div>
            </div>
        </div>
